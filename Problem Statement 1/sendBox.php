<?php
	...
	$getInboxMessages="SELECT full_name, receiver, subject, content, send_at, is_read, message_id FROM messages, users WHERE sender='$email' and users.email=receiver ORDER BY send_at DESC";
	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer
	  ...
	  <header class="mdl-layout__header">
	    <div class="mdl-layout__header-row">
	        <h3 style="background: -webkit-linear-gradient(#fff, #fff); -webkit-background-clip:text; color: transparent;">ISRO-Mail</h4>
